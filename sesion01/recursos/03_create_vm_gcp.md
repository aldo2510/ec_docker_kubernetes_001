...
--tags=http-server,https-server --create-disk=auto-delete=yes,boot=yes,device-name=devops-jenkins-server,image=projects/centos-cloud/global/images/centos-stream-9-v20241112,mode=rw,size=50,type=projects/hypnotic-epoch-411523/zones/us-west4-b/diskTypes/pd-balanced \
